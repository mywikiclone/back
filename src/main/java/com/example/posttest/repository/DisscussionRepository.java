...
public interface DisscussionRepository extends JpaRepository<DiscussionTopic,Long> {
    ...
    @Query("select new com.example.posttest.dtos.TopicDto(d.topic_title,d.origin_proposer_id,d.topic_id,d.subject_title,d.writer_email) from DiscussionTopic d order by d.Create_Time asc ")
